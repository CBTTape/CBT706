...
<!--
    Line Chart Transformer 1.0.246
...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="inset" select="5"/>
    <xsl:variable name="defaultMarginSize" select="10"/>
    <xsl:variable name="defaultChartTitleHeight" select="40"/>
    <xsl:variable name="defaultTitleHeight" select="20"/>
    <xsl:variable name="defaultLabelHeight" select="10"/>
    <xsl:variable name="defaultLegendEntryHeight" select="10"/>
    <xsl:variable name="defaultLegendEntryWidth" select="$chartWidth div 5"/>
    ...
    <xsl:variable name="southHeight" select="$chartMargin + $southLegendDisplayHeight + $inset + $southTitleHeight + $southLabelHeight"/>
    ...
    <xsl:variable name="eastLegendWidth">
        <xsl:call-template name="getValueOrDefault">
    ...
    <xsl:variable name="eastLegendDisplayWidth">
        <xsl:choose>
            <xsl:when test="//layout/east/legend">
                <xsl:value-of select="$eastLegendWidth"/>
            </xsl:when>
            <xsl:otherwise>0</xsl:otherwise>
        </xsl:choose>
    </xsl:variable>
    <xsl:variable name="eastWidth" select="$eastLabelWidth + $eastTitleHeight + $inset + $eastLegendDisplayWidth + $chartMargin"/>
    ...
    <xsl:variable name="westWidth" select="$chartMargin + $westTitleHeight + $westLabelWidth"/>
...
&lt;![CDATA[</xsl:text>
        ...
        .label          {stroke:none;fill:black;font-size:<xsl:value-of select="$defaultLabelHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/label/text())"/>;}
        .labelX         {font-size:<xsl:value-of select="$southLabelHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/label/x/text())"/>;text-anchor:middle;}
        .labelY         {font-size:<xsl:value-of select="$westLabelHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/label/y/text())"/>;text-anchor:end;}
        .labelX2        {font-size:<xsl:value-of select="$northLabelHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/label/x2/text())"/>;text-anchor:middle;}
        .labelY2        {font-size:<xsl:value-of select="$eastLabelHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/label/y2/text())"/>;text-anchor:start;}
        .title          {fill:gold;stroke:goldenrod;font-size:<xsl:value-of select="$chartTitleHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/title/text())"/>;text-anchor:middle;}
        .titleX         {fill:black;font-size:<xsl:value-of select="$southTitleHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/title/x/text())"/>;text-anchor:middle;}
        .titleX2        {fill:black;font-size:<xsl:value-of select="$northTitleHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/title/x2/text())"/>;text-anchor:middle;}
        .titleY         {fill:black;font-size:<xsl:value-of select="$westTitleHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/title/y/text())"/>;text-anchor:middle;}
        .titleY2        {fill:black;font-size:<xsl:value-of select="$eastTitleHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/title/y2/text())"/>;text-anchor:middle;}
        .plotarea       {<xsl:choose>
        ...
        .legend         {stroke:none;fill:black;font-size:<xsl:value-of select="$defaultLegendEntryHeight"/>px;<xsl:value-of select="normalize-space(/chart/style/legend/text())"/>;}
        ...
        .annotationText {fill:black;fill-opacity:0.7;stroke:none;<xsl:value-of select="normalize-space(/chart/style/annotation/text/text())"/>;text-anchor:middle;}
...
<xsl:text disable-output-escaping="yes">]]&gt;
            ...
            <g transform="matrix(1 0 0 -1 {$westWidth} {$northHeight + $plotareaHeight})">
                <g class="label">
                    <xsl:if test="//layout/south/legend">
                        ...
                        <xsl:call-template name="drawLegend">
                            ...
                            <xsl:with-param name="legendOriginY" select="-$southLabelHeight - $southTitleHeight"/>
                    ...
                    <xsl:if test="//layout/east/legend">
                        ...
                        <xsl:call-template name="drawLegend">
                            <xsl:with-param name="legendOriginX" select="$plotareaWidth  + $eastLabelWidth  + $eastTitleHeight"/>
                            <xsl:with-param name="legendOriginY" select="$plotareaHeight"/>
                            <xsl:with-param name="legendWidth" select="$eastLegendWidth"/>
                    ...
                    <xsl:if test="string(number($rangeMinX)) != 'NaN'">
                        <g class="labelX" transform="matrix(1 0 0 -1 0 {-$southLabelHeight})">
                    ...
                    <xsl:if test="/chart/layout/north/label and string(number($rangeMinX2)) != 'NaN'">
                        <g class="labelX2" transform="matrix(1 0 0 -1 0 {$plotareaHeight + $inset})">
                ...
                <g class="title" transform="matrix(1 0 0 -1 {-$westWidth} {$plotareaHeight + $inset + $northLabelHeight + $northTitleHeight})" filter="url(#shadowFilter)">
                ...
                <xsl:if test="/chart/axis/x/title">
                    <g class="titleX" transform="matrix(1 0 0 -1 0 {-$southLabelHeight - $southTitleHeight})">
                ...
                <xsl:if test="/chart/axis/y/title">
                    <g class="titleY" transform="matrix(1 0 0 -1 {-$westLabelWidth} 0), rotate(-90 0 {-$plotareaHeight * 0.5})">
                ...
                <xsl:if test="/chart/axis/x2/title">
                    <g class="titleX2" transform="matrix(1 0 0 -1 0 {$plotareaHeight + $inset + $northLabelHeight})">
                ...
                <xsl:if test="/chart/axis/y2/title">
                    <g class="titleY2" transform="matrix(1 0 0 -1 {$plotareaWidth + $eastLabelWidth} 0), rotate(-90 0 {-$plotareaHeight * 0.5})">
    ...
    <xsl:template match="/chart/style/plotarea/picture">
        ...
        <xsl:variable name="filter" select="concat('pictureFilter',position())"/>
        <xsl:element name="image" xmlns:xlink="http://www.w3.org/1999/xlink">
            <xsl:attribute name="xlink:href">
                <xsl:value-of select="$protocol"/>
                <xsl:value-of select="normalize-space(text())"/>
            </xsl:attribute>
            <xsl:if test="@opacity or $location = 'tile'">
            ...
            <xsl:if test="@opacity or $location = 'tile'">
                ...
                <filter primitiveUnits="objectBoundingBox" filterUnits="objectBoundingBox"
                    x="0" y="0" width="{$tileareaWidth}%" height="{$tileareaHeight}%" id="{$filter}">
    ...
    <xsl:template name="drawLabelOnYAxis">
        ...
        <xsl:param name="by"/>
        <xsl:element name="text">
            <xsl:attribute name="x"><xsl:value-of select="-$inset"/></xsl:attribute>
            <xsl:attribute name="y">
